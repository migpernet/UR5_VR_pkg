#!/usr/bin/env python3
# real_test_streaming_vr_90hz.py
import rospy
import math
...
rospy.init_node('test_streaming_vr_node')
rospy.Subscriber('/joint_states', JointState, js_cb)

rospy.loginfo("Aguardando leitura de /joint_states...")
...
rospy.loginfo("Iniciando streaming suave senoidal a 90 Hz (pressione Ctrl+C para parar)...")
...
while not rospy.is_shutdown():
    ...
    # Duração dinâmica de amortecimento compatível com a taxa de envio
